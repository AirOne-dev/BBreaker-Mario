...
let max_balls = 200;
let lost_balls = 0; // le nombre de balles que le joueur a laissé tomber
let total_balls = 0; // le nombre total de balles qui sont apparues dans la partie
let text_score = document.querySelector('#score');
let barre_speed = 4; // la vitesse de la barre
